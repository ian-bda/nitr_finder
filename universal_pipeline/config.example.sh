...
# --- optional RNA (leave empty to skip 08a; 8b then reports V/I only) ---
RNA_R1=""
RNA_R2=""
STAR_READ_CMD="zcat"                            # zcat for .gz, cat for uncompressed .fastq
# PacBio Iso-Seq clustered FASTA (one file) or a directory of *.fa / *.fasta
RNA_ISOSEQ=""
MINIMAP2="$(command -v minimap2 2>/dev/null || true)"
